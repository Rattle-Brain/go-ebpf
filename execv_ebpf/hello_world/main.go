//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target bpfel -cc clang code code.bpf.code -- -I/usr/include/linux/bpf.h
...
func main() {
    ...
    link, err := objs.TraceExecve.Attach()
    if err != nil {
