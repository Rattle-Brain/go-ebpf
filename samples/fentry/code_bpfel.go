...
type codeProgramSpecs struct {
	FentryVfsUnlink *ebpf.ProgramSpec `ebpf:"fentry_vfs_unlink"`
	FexitVfsUnlink  *ebpf.ProgramSpec `ebpf:"fexit_vfs_unlink"`
}
...
type codePrograms struct {
	FentryVfsUnlink *ebpf.Program `ebpf:"fentry_vfs_unlink"`
	FexitVfsUnlink  *ebpf.Program `ebpf:"fexit_vfs_unlink"`
}
